...
case class IncrementOptions(
  ...
  /** The amount to initialise the document too, if it does not exist.  If this is
    ...
    */
  def initial(value: Long): IncrementOptions = {
  ...
  /** Changes the durability setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def durability(value: Durability): IncrementOptions = {
  ...
  /** Changes the timeout setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def timeout(value: Duration): IncrementOptions = {
    copy(timeout = value)
  }
  ...
  /** Changes the parent span setting used for this operation.
    ...
    */
  @Volatile
  def parentSpan(value: RequestSpan): IncrementOptions = {
  ...
  /** Changes the parent span setting used for this operation.
    ...
    */
  @Volatile
  def parentSpan(value: Option[RequestSpan]): IncrementOptions = {
  ...
  /** Provides some control over how the SDK handles failures.  Will default to `retryStrategy()`
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def retryStrategy(value: RetryStrategy): IncrementOptions = {
  ...
  /** Changes the expiry setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def expiry(value: Duration): IncrementOptions = {
    copy(expiry = value)
  }
  ...
  /** Changes the expiry setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def expiry(value: Option[Duration]): IncrementOptions = {
    value match {
  ...
  /** Changes the expiry setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def expiry(value: Instant): IncrementOptions = {
