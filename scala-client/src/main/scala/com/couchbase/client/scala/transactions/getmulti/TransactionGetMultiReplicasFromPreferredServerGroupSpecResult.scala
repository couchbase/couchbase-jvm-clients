...
private[transactions] case class TransactionGetMultiReplicasFromPreferredServerGroupSpecResult(
    spec: TransactionGetMultiReplicasFromPreferredServerGroupSpec,
