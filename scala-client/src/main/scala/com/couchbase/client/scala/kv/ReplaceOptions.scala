...
case class ReplaceOptions(
  ...
  /** Couchbase documents all have a CAS (Compare-And-Set) field, a simple integer that allows
    ...
    */
  def cas(value: Long): ReplaceOptions = {
    copy(cas = value)
  }
  ...
  /** Changes the durability setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def durability(value: Durability): ReplaceOptions = {
  ...
  /** Changes the timeout setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def timeout(value: Duration): ReplaceOptions = {
    copy(timeout = value)
  }
  ...
  /** Changes the expiry setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def expiry(value: Duration): ReplaceOptions = {
    copy(expiry = value)
  }
  ...
  /** Changes the expiry setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def expiry(value: Option[Duration]): ReplaceOptions = {
    value match {
  ...
  /** Changes the expiry setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def expiry(value: Instant): ReplaceOptions = {
    copy(expiryTime = Some(value))
  }

  /** Changes whether the document's expiry should be preserved.
    * Defaults to false.
    *
  ...
  /** Changes the transcoder used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def transcoder(value: Transcoder): ReplaceOptions = {
  ...
  /** Provides some control over how the SDK handles failures.  Will default to `retryStrategy()`
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def retryStrategy(value: RetryStrategy): ReplaceOptions = {
