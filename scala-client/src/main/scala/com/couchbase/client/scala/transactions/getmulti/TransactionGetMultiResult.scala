...
/** The result of a getMulti operation. */
@Stability.Uncommitted
case class TransactionGetMultiResult private[transactions] (
    private val results: Seq[TransactionGetMultiSpecResult]
) {
  ...
  private def result(specIndex: Int): TransactionGetMultiSpecResult = {
    validateIndex(specIndex)
