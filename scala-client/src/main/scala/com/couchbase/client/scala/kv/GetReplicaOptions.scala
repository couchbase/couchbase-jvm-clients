...
/** Provides control over how a `getReplica` operation is performed.
  */
case class GetReplicaOptions(
  ...
  /** Changes the timeout setting used for this operation.
    ...
    */
  def timeout(value: Duration): GetReplicaOptions = {
    copy(timeout = value)
  }
  ...
  /** Changes the parent span setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def parentSpan(value: RequestSpan): GetReplicaOptions = {
    copy(parentSpan = Some(value))
  }

  /** Changes the transcoder used for this operation.
    *
    * The transcoder provides control over how JSON is converted from what is stored on the Couchbase Server.
    *
    * If not specified it will default to `transcoder()` in the
    * [[com.couchbase.client.scala.env.ClusterEnvironment]].
    *
    * @return a copy of this with the change applied, for chaining.
    */
  def transcoder(value: Transcoder): GetReplicaOptions = {
  ...
  /** Provides some control over how the SDK handles failures.  Will default to `retryStrategy()`
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def retryStrategy(value: RetryStrategy): GetReplicaOptions = {
