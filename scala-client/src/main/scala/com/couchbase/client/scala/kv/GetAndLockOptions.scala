...
case class GetAndLockOptions(
  ...
  /** Changes the timeout setting used for this operation.
    ...
    */
  def timeout(value: Duration): GetAndLockOptions = {
    copy(timeout = value)
  }
  ...
  /** Changes the parent span setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def parentSpan(value: RequestSpan): GetAndLockOptions = {
  ...
  /** Changes the parent span setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def parentSpan(value: Option[RequestSpan]): GetAndLockOptions = {
  ...
  /** Changes the transcoder used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def transcoder(value: Transcoder): GetAndLockOptions = {
  ...
  /** Provides some control over how the SDK handles failures.  Will default to `retryStrategy()`
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def retryStrategy(value: RetryStrategy): GetAndLockOptions = {
