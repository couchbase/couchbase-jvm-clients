...
case class RemoveOptions(
  ...
  /** Couchbase documents all have a CAS (Compare-And-Set) field, a simple integer that allows
    ...
    */
  def cas(value: Long): RemoveOptions = {
    copy(cas = value)
  }
  ...
  /** Changes the durability setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def durability(value: Durability): RemoveOptions = {
  ...
  /** Changes the timeout setting used for this operation.
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def timeout(value: Duration): RemoveOptions = {
    copy(timeout = value)
  }
  ...
  /** Changes the parent span setting used for this operation.
    ...
    */
  @Volatile
  def parentSpan(value: RequestSpan): RemoveOptions = {
  ...
  /** Changes the parent span setting used for this operation.
    ...
    */
  @Volatile
  def parentSpan(value: Option[RequestSpan]): RemoveOptions = {
  ...
  /** Provides some control over how the SDK handles failures.  Will default to `retryStrategy()`
    ...
    * @return a copy of this with the change applied, for chaining.
    */
  def retryStrategy(value: RetryStrategy): RemoveOptions = {
