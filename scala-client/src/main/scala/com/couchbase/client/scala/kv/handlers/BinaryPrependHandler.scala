...
import com.couchbase.client.core.msg.kv.{KeyValueRequest, PrependRequest, PrependResponse}
    ...
    if (validations.isFailure) {
      ...
      Success(
        new PrependRequest(
          ...
          hp.tracer.requestSpan(TracingIdentifiers.SPAN_REQUEST_KV_PREPEND, parentSpan.orNull)
        )
      )
    }
  }
