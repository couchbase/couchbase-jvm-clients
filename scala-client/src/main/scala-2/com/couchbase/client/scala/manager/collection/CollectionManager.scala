...
class CollectionManager(async: AsyncCollectionManager) {
  ...
  def getScope(
    ...
    AsyncUtils.block(async.getScope(scopeName, timeout, retryStrategy))
  }
  ...
  def getAllScopes(
    ...
    AsyncUtils.block(async.getAllScopes(timeout, retryStrategy))
  }
  ...
  def createCollection(
    ...
    AsyncUtils.block(async.createCollection(collection, timeout, retryStrategy))
  }
  ...
  def dropCollection(
    ...
    AsyncUtils.block(async.dropCollection(collection, timeout, retryStrategy))
  }
  ...
  def dropCollection(
    ...
    AsyncUtils.block(async.dropCollection(scopeName, collectionName, timeout, retryStrategy))
  }
  ...
  def createScope(
    ...
    AsyncUtils.block(async.createScope(scopeName, timeout, retryStrategy))
  }
  ...
  def dropScope(
    ...
    AsyncUtils.block(async.dropScope(scopeName, timeout, retryStrategy))
  }
}
