...
class BucketManager(val async: AsyncBucketManager) {
  ...
  def updateBucket(
    ...
    AsyncUtils.block(async.updateBucket(settings, timeout, retryStrategy))
  }
  ...
  def dropBucket(
    ...
    AsyncUtils.block(async.dropBucket(bucketName, timeout, retryStrategy))
  }
  ...
  def getBucket(
    ...
    AsyncUtils.block(async.getBucket(bucketName, timeout, retryStrategy))
  }
  ...
  def getAllBuckets(
    ...
    AsyncUtils.block(async.getAllBuckets(timeout, retryStrategy))
  }
  ...
  def flushBucket(
    ...
    AsyncUtils.block(async.flushBucket(bucketName, timeout, retryStrategy))
  }
}
