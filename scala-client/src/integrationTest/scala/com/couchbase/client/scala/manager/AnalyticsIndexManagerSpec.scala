...
class AnalyticsIndexManagerSpec extends ScalaIntegrationTest {
  ...
  def beforeEach(): Unit = {
    ...
    analytics
      ...
      .get
      .foreach(index =>
        analytics.dropIndex(index.name, index.datasetName, Some(index.dataverseName)).get)
  }
  ...
  def createIndex(): Unit = {
    ...
    val fields = Map("a" -> AnalyticsDataType.AnalyticsInt64,
