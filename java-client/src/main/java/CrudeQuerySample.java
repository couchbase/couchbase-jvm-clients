...
public class CrudeQuerySample {
  ...
  public static void main(String... args) throws Exception {
    ...
    QueryRequest request = new QueryRequest(Duration.ofSeconds(10), core.context(), environment.retryStrategy(), environment.credentials(), query, new QueryResponse.QueryEventSubscriber() {
      @Override
