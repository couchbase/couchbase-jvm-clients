...
public class GetReplicaOptions extends CommonOptions<GetReplicaOptions> {

  public static GetReplicaOptions getReplicaOptions() {
    return new GetReplicaOptions();
  }

  private Transcoder transcoder;

  private GetReplicaOptions() {
  }
   ...
   */
  public GetReplicaOptions transcoder(final Transcoder transcoder) {
