...
public class TransactionGetMultiReplicasFromPreferredServerGroupResult {
    private final List<TransactionGetMultiReplicasFromPreferredServerGroupSpecResult> results;

    @Stability.Internal
    public TransactionGetMultiReplicasFromPreferredServerGroupResult(List<TransactionGetMultiReplicasFromPreferredServerGroupSpecResult> results) {
    ...
    private TransactionGetMultiReplicasFromPreferredServerGroupSpecResult get(int specIndex) {
        if (!exists(specIndex)) {
