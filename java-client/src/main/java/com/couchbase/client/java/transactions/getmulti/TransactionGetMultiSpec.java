...
public class TransactionGetMultiSpec {
     ...
     */
    public static TransactionGetMultiSpec create(Collection collection, String id) {
        return new TransactionGetMultiSpec(collection, id);
    }
     ...
     */
    public TransactionGetMultiSpec transcoder(Transcoder transcoder) {
        this.transcoder = requireNonNull(transcoder);
        return this;
    }

    @Stability.Internal
    TransactionGetMultiSpec(Collection collection, String id) {
    ...
    public String toString() {
        return "TransactionGetMultiSpec{" +
                "id=" + RedactableArgument.redactUser(id) +
                '}';
    }
}
