...
public class UpsertOptions<T> {

  public static UpsertOptions<Object> DEFAULT = UpsertOptions.create();
  ...
  private UpsertOptions(Builder<T> builder) {
  ...
  public static <T> UpsertOptions<T> create() {
