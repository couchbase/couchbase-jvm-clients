 ...
 */
public class ResumeFunctionOptions extends CommonDropOptions<ResumeFunctionOptions> {
  private ResumeFunctionOptions() {
  }
   ...
   */
  public static ResumeFunctionOptions resumeFunctionOptions() {
    return new ResumeFunctionOptions();
  }
