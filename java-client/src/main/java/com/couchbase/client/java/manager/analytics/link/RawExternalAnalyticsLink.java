...
public class RawExternalAnalyticsLink extends AnalyticsLink {
  ...
  private RawExternalAnalyticsLink(ObjectNode json) {
    super(json.path("name").asText(), Optional.ofNullable(json.path("dataverse").textValue())
        .orElse(json.path("scope").asText()));
  ...
  public Map<String, String> toMap() {
    throw new UnsupportedOperationException("This version of the Couchbase SDK does not know how to update analytics links of type '" + type + "'.");
  }
