 ...
 */
public class PauseFunctionOptions extends CommonDropOptions<PauseFunctionOptions> {
  private PauseFunctionOptions() {
  }
   ...
   */
  public static PauseFunctionOptions pauseFunctionOptions() {
    return new PauseFunctionOptions();
  }
