 ...
 * except on an AUTHENTICATION_ERROR, which will immediately fast-fail the operation with an {@link AuthenticationFailureException}.
 */
public class FastFailOnAuthErrorRetryStrategy implements RetryStrategy {
  public static FastFailOnAuthErrorRetryStrategy INSTANCE = new FastFailOnAuthErrorRetryStrategy();
