 ...
 *
 * If you want to add more tests, just add them to the {@link #inputProvider()} as
...
class MemcacheProtocolDecoderTest {
     ...
     *
     * For now each input is tried 100 times with different chunk sizes to increase
     ...
     *
     * Most of those dumps are taken from real applications, that's why
