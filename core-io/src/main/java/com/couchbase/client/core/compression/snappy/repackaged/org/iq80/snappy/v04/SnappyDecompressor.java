 ...
 * the original.
 *
 * incrementalCopyFastPath was modified to throw CorruptionException
 * instead of going into an infinite loop.
 */
package com.couchbase.client.core.compression.snappy.repackaged.org.iq80.snappy.v04;

import static com.couchbase.client.core.compression.snappy.repackaged.org.iq80.snappy.v04.SnappyInternalUtils.copyLong;
import static com.couchbase.client.core.compression.snappy.repackaged.org.iq80.snappy.v04.SnappyInternalUtils.loadByte;
import static com.couchbase.client.core.compression.snappy.repackaged.org.iq80.snappy.v04.SnappyInternalUtils.lookupShort;
...
final class SnappyDecompressor
{
            ...
            throws CorruptionException
    {
        ...
        while (ipIndex < ipLimit - 5) {
            ...
            if ((opCode & 0x3) == SlowSnappy.LITERAL) {
    ...
    private static void incrementalCopyFastPath(byte[] output, int srcIndex, int opIndex, int length)
    {
        ...
        while ((opIndex + copiedLength) - srcIndex < 8) {
            ...
            // BEGIN COUCHBASE MODIFICATION to avoid infinite loop
            int delta = (opIndex + copiedLength) - srcIndex;
            if (delta <= 0) {
              throw new CorruptionException("Malformed input; no forward progress in incrementalCopyFastPath");
            }
            copiedLength += delta;
            // END COUCHBASE MODIFICATION
        }
