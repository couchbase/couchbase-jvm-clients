...
public class QueryHandlerSwitcher extends ChunkedHandlerSwitcher {
  ...
  public QueryHandlerSwitcher(final BaseEndpoint endpoint, final EndpointContext context) {
    super(
      new QueryMessageHandler(endpoint, context),
      new NonChunkedQueryMessageHandler(endpoint),
      QueryRequest.class
    );
  }
