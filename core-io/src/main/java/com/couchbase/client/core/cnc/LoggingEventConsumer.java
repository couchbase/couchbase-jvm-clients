...
public class LoggingEventConsumer implements Consumer<Event> {
     ...
     */
    private static final boolean SLF4J_AVAILABLE = SFL4JOnClasspath();
     ...
     */
    private static boolean SFL4JOnClasspath() {
        try {
    ...
    static class ConsoleLogger implements Logger {
        ...
        public synchronized void trace(String format, Object... arguments) {
            this.log.format("[TRACE] (%s) %s\n", Thread.currentThread().getName(), formatHelper(format, arguments));
        }
        @Override
