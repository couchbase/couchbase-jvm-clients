 ...
 */
@Stability.Internal
public class CoreTransactionCommitAmbiguousException extends CoreTransactionFailedException {
    public CoreTransactionCommitAmbiguousException(Throwable cause, CoreTransactionLogger logger, String transactionId, String msg) {
