...
public class ConnectTimings {
    ...
    private static final AttributeKey<ConnectTimings> ATTRIBUTE_KEY = AttributeKey.newInstance("ConnectTimings");
    ...
    public static Optional<Duration> stop(final Channel channel, final Class<?> clazz, boolean timeout) {
        ConnectTimings timings = channel.attr(ATTRIBUTE_KEY).get();
    ...
    static class Timing {
        ...
        public boolean equals(Object o) {
            ...
            if (start != timing.start) return false;
            if (end != timing.end) return false;
            if (timeout != timing.timeout) return false;
