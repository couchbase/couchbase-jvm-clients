...
public class IdleStreamingEndpointClosedEvent extends AbstractEvent {
  ...
  public IdleStreamingEndpointClosedEvent(final IoContext context) {
    super(Severity.DEBUG, Category.IO, Duration.ZERO, context);
  }

  @Override
  public String description() {
    return "Proactively closed an idle HTTP streaming based on the configured configIdleRedialTimeout";
  }
