 ...
 * @since 2.0.0
 */
public class EndpointDisconnectedEvent extends AbstractEvent {
   ...
   */
  public EndpointDisconnectedEvent(final Duration duration, final EndpointContext context) {
    super(Severity.DEBUG, Category.ENDPOINT, duration, context);
  }

  @Override
  public String description() {
    return "Endpoint disconnected successfully";
  }
}
