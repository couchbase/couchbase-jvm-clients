...
public class SearchServiceConfig implements ServiceConfig {
  ...
  public static SearchServiceConfig create() {
    return create(DEFAULT_MIN_ENDPOINTS, DEFAULT_MAX_ENDPOINTS, DEFAULT_IDLE_TIME);
  }

  public static SearchServiceConfig create(int maxEndpoints) {
  ...
  public static SearchServiceConfig create(int minEndpoints, int maxEndpoints, Duration idleTime) {
    return new SearchServiceConfig(minEndpoints, maxEndpoints, idleTime);
  }

  private SearchServiceConfig(int minEndpoints, int maxEndpoints, Duration idleTime) {
