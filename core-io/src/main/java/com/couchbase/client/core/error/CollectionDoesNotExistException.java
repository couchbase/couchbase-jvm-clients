 ...
 * @since 2.0.0
 */
public class CollectionDoesNotExistException extends CouchbaseException {
  ...
  public CollectionDoesNotExistException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
