...
public class AnalyticsHandlerSwitcher extends ChunkedHandlerSwitcher {
  ...
  public AnalyticsHandlerSwitcher(final BaseEndpoint endpoint, final EndpointContext context) {
    super(
      new AnalyticsMessageHandler(endpoint, context),
      new NonChunkedAnalyticsMessageHandler(endpoint),
