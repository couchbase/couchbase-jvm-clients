 ...
 *
 * <p>Note that warnings are not terminal errors but hints from the engine that something was not as expected.</p>
 */
@Stability.Internal
public class CoreQueryWarning {
  ...
  public CoreQueryWarning(final ErrorCodeAndMessage inner) {
