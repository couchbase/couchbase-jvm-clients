...
public class AnalyticsErrorContext extends ErrorContext {

  private final RequestContext requestContext;
  private final List<ErrorCodeAndMessage> errors;
  private final int httpStatus;

  public AnalyticsErrorContext(final RequestContext requestContext, final List<ErrorCodeAndMessage> errors, final int httpStatus) {
    super(null);
    this.errors = errors;
