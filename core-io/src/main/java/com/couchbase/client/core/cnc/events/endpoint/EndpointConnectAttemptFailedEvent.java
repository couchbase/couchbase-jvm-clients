 ...
 * @since 2.0.0
 */
public class EndpointConnectAttemptFailedEvent extends AbstractEvent {

  private final long attempt;
  private final Throwable cause;

  public EndpointConnectAttemptFailedEvent(Duration duration, EndpointContext context,
