...
public class ReconfigurationCompletedEvent extends AbstractEvent {
  ...
  public ReconfigurationCompletedEvent(final Duration duration, final Context context) {
    super(Severity.DEBUG, Category.CORE, duration, context);
  }

  @Override
  public String description() {
    return "Reconfiguration attempt completed.";
  }
