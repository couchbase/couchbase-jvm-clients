...
final class SnappyCompressor
{
            ...
            final boolean allowFastPath)
    {
        ...
        if (n < 60) {
            ...
            output[outputIndex++] = (byte) (SlowSnappy.LITERAL | n << 2);
            ...
            output[outputIndex++] = (byte) (SlowSnappy.LITERAL | 59 + 1 << 2);
            output[outputIndex++] = (byte) (n);
        }
        else if (n < (1 << 16)) {
            output[outputIndex++] = (byte) (SlowSnappy.LITERAL | 59 + 2 << 2);
            output[outputIndex++] = (byte) (n);
            output[outputIndex++] = (byte) (n >>> 8);
        }
        else if (n < (1 << 24)) {
            output[outputIndex++] = (byte) (SlowSnappy.LITERAL | 59 + 3 << 2);
            output[outputIndex++] = (byte) (n);
            output[outputIndex++] = (byte) (n >>> 8);
            output[outputIndex++] = (byte) (n >>> 16);
        }
        else {
            output[outputIndex++] = (byte) (SlowSnappy.LITERAL | 59 + 4 << 2);
            output[outputIndex++] = (byte) (n);
            output[outputIndex++] = (byte) (n >>> 8);
            output[outputIndex++] = (byte) (n >>> 16);
            ...
            int length)
    {
        ...
        if ((length < 12) && (offset < 2048)) {
            ...
            output[outputIndex++] = (byte) (SlowSnappy.COPY_1_BYTE_OFFSET | ((lenMinus4) << 2) | ((offset >>> 8) << 5));
            output[outputIndex++] = (byte) (offset);
        }
        else {
            output[outputIndex++] = (byte) (SlowSnappy.COPY_2_BYTE_OFFSET | ((length - 1) << 2));
            output[outputIndex++] = (byte) (offset);
