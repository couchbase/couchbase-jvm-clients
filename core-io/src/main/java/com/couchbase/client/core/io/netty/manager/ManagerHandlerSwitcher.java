...
public class ManagerHandlerSwitcher extends ChunkedHandlerSwitcher {
  public ManagerHandlerSwitcher(final BaseEndpoint endpoint, final EndpointContext context) {
    super(new ManagerMessageHandler(endpoint, context),
        new NonChunkedManagerMessageHandler(endpoint),
