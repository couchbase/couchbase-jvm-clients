...
internal class QueryExecutor(
    ...
    private fun CommonOptions.actualQueryTimeout() = timeout ?: core.env.timeoutConfig().queryTimeout()
    private fun CommonOptions.actualRetryStrategy() = retryStrategy ?: core.env.retryStrategy()
    private fun CommonOptions.actualSpan(name: String) = core.env.requestTracer().requestSpan(name, parentSpan)
